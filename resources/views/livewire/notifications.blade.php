<div>
    ...
    @if(!Auth::user()->is_admin)
        ...
        @foreach(auth()->user()->unreadNotifications->where('type' , 'App\Notifications\NewIssueNotification')
        as
        $notification)
            <div class="px-6 py-2">
                    ...
                    <div class="flex flex-row px-4 space-x-4">
                        ...
                        <div class="flex flex-col overflow-hidden">
                            <div class="justify-start flex-1 mb-2">
                                ...
                                <p class="mt-3 mb-1 text-sm font-normal text-gray-400 dark:text-primary-lighter">
                                    Admin <span
                                        class="px-2 py-1 text-sm font-semibold bg-primary-50 text-primary-light dark:bg-primary-darker">{{$notification->data['name']}}</span>
                                    Issued your requested book
                                    <span
                            ...
                            <div class="flex justify-between ">
                                ...
                                <span
                                    ...
                                    <button
                                        class="p-1 px-2 rounded-md bg-primary-50 text-primary-light dark:bg-primary-darker"
                                        wire:click="markAsRead('{{ $notification->id }}')">
                                        Mark as read
                                    </button>
    ...
    @if(Auth::user()->is_admin)
            ...
            @foreach(auth()->user()->unreadNotifications->where('type' , 'App\Notifications\NewRequestNotification')
            as
            $notification)
                <div class="px-6 py-2">
                    <div class="block alert">
