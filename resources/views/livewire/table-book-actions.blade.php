<div>
    <div class="flex items-center justify-center">
        <button wire:click="editBook({{$id}})" class="p-1 text-blue-600 rounded hover:bg-blue-600 hover:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" class="cursor-pointer icon icon-tabler icon-tabler-edit" width="20"
                class="w-5 h-5" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none"
