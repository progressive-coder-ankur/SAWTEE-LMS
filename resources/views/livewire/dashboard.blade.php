<div class="">
    @include('livewire.book-issue-form')
    <div class="grid grid-cols-1 col-span-10 pb-20 bg-blue-100">
        ...
        <div class="container px-4 m-auto mt-6">
                ...
                <div class="grid grid-cols-2 col-span-8 gap-4 p-4 md:grid-cols-3 rounded-2xl">
                    ...
                    <div class="flex items-center justify-between p-4 bg-white rounded-md shadow-lg dark:bg-darker">
                        <div>
                            ...
                            <span class="text-xl font-semibold">{{$bookIssued->count()}}</span>
                        </div>
                        <div>
                            <span>
                                <svg class="w-12 h-12 text-gray-300 dark:text-primary-dark"
                    ...
                    <div class="flex items-center justify-between p-4 bg-white rounded-md shadow-lg dark:bg-darker">
                        <div>
                            ...
                            <span class="text-xl font-semibold">{{$participants->count()}}</span>
                        </div>
                        <div>
                            <span>
                                <svg class="w-12 h-12 text-gray-300 dark:text-primary-dark" fill="none"
            ...
            <div class="grid grid-cols-1 mt-6 lg:gap-4 gap-y-4 lg:grid-cols-12">
                    ...
                    <ul class="flex border-b border-primary">
                        ...
                        <li @click="openTab = 2" class="mr-1" :class="{ '-mb-px': openTab === 2 }">
                            <button :class="openTab === 2 ? activeClasses : inactiveClasses"
                                class="inline-block px-4 py-2 font-semibold bg-white focus:outline-none text-primary dark:bg-darker hover:text-primary-dark dark:border-primary dark:text-primary-dark">Issued
                                Book Requests</button>
                        </li>
                    </ul>
                    <div class="w-full">
                        <div x-show="openTab === 1">
                            <livewire:request-table hideable="inline" searchable="requested_by, book_name">
                        </div>
                        <div x-show="openTab === 2">
                            <livewire:issued-book-requests-table hideable="inline" searchable="requested_by, book_name">
                        </div>
                    </div>

                </div>
                <div
                    class="grid items-center justify-center col-span-1 bg-white max-h-96 lg:col-span-4 rounded-2xl dark:bg-darker">
            ...
            <div class="grid grid-cols-1 gap-4 mt-6 lg:grid-cols-12">
                ...
                <div class="grid h-full col-span-12 bg-white dark:bg-dark rounded-2xl md:col-span-8">
                    ...
                    <div class="flex px-6 py-4">
                        <table class="w-full table-auto min-w-max">
                            ...
                            <thead>
                                <tr
                                    class="text-sm leading-normal text-gray-600 uppercase bg-gray-200 dark:text-light dark:bg-gray-700">
                            ...
                            <tbody class="text-sm font-light text-gray-600 dark:text-light">
                                ...
                                <tr
                                    ...
                                    <td class="px-6 py-3 text-left whitespace-nowrap">
                                        <div class="flex items-center">
                                            <span class="font-medium">{{$participant->event_name}}</span>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
