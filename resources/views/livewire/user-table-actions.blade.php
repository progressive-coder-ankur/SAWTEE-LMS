<div class="flex items-center justify-center">
    ...
    <button class="p-1 text-green-600 rounded hover:bg-green-600 hover:text-white">
        <a href="{{ route('user.show', $id) }}">
            <svg class="w-5 h-5" height="20" width="20" class="cursor-pointer icon icon-tabler icon-tabler-edit"
    ...
    <button class="p-1 text-blue-600 rounded hover:bg-blue-600 hover:text-white">
        <a href="/user/profile"><svg xmlns="http://www.w3.org/2000/svg"
                class="cursor-pointer icon icon-tabler icon-tabler-edit" width="20" class="w-5 h-5" height="20"
