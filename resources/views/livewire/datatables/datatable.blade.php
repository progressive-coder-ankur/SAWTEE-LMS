<div>
    ...
    <div class="relative">
        <div class="flex items-center justify-between mb-4">
            <div class="flex items-center flex-grow h-16">
                @if($this->searchableColumns()->count())
                <div class="flex rounded-lg shadow-md w-96">
                    <div class="relative flex-grow focus-within:z-10">
                        ...
                        <input wire:model.debounce.500ms="search"
                            class="block w-full h-10 pl-10 transition duration-150 ease-in-out rounded-md form-input bg-gray-50 focus:bg-white sm:text-sm sm:leading-5"
                            placeholder="Search in {{ $this->searchableColumns()->take(3)->map->label->join(', ') }}" />
                ...
                <button wire:click="deleteSelected()"
                    class="inline-flex justify-center px-4 py-2 ml-4 space-x-2 text-sm font-medium text-white bg-gray-700 border border-transparent rounded-md shadow-sm hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-reds-500">
                    <a class="flex items-center">
                        <x-icons.trash-can /> &nbsp;Delete Selected</a>
                </button>
                @endif
            </div>
            ...
            <div class="flex items-center space-x-1">
                ...
                <div x-data="{ init() {
                    ...
                    <button wire:click="export"
                        class="flex items-center px-3 space-x-2 text-xs font-medium leading-4 tracking-wider text-green-500 uppercase bg-white border border-green-400 rounded-md hover:bg-green-200 focus:outline-none"><span>Export</span>
        ...
        <div class="overflow-x-scroll bg-white rounded-lg shadow-lg max-w-screen">
            <div class="rounded-lg @unless($this->hidePagination) rounded-b-none @endif">
                <div class="min-w-full align-middle table-auto">
                    ...
                    <div class="table-row divide-x divide-gray-200">
                        ...
                        <div
                            class="relative flex items-center table-cell w-48 h-12 px-6 py-3 overflow-hidden text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase align-top border-b border-gray-200 bg-gray-50 focus:outline-none">
                            <div
                    ...
                    <div class="table-row bg-blue-100 divide-x divide-blue-200">
                        ...
                        @elseif($column['type'] === 'checkbox')
                        <div
                            class="flex flex-col items-center w-32 h-full px-6 py-5 space-y-2 overflow-hidden text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase align-top bg-blue-100 border-b border-gray-200 bg-gray-50 focus:outline-none">
                            <div>SELECT ALL</div>
                            <div>
                    ...
                    @empty
                    <p class="items-center justify-center p-3 text-lg text-teal-600">
