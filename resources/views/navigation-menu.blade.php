        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('issued.books') }}" :active="request()->routeIs('issued.books')">
                        {{ __('Issued Books') }}
                    </x-jet-nav-link>

                    <x-jet-nav-link href="{{ route('returned.books') }}" :active="request()->routeIs('returned.books')">
                        {{ __('Returned Books') }}
                    </x-jet-nav-link>
                    ...
                    <x-jet-nav-link href="{{ route('request.book') }}" :active="request()->routeIs('request.book')">
                        {{ __('Request Books') }}
                    </x-jet-nav-link>

                    <x-jet-nav-link href="#" :active="request()->routeIs('request.book')">
                        {{ __('Request Item') }}
                    </x-jet-nav-link>
                    @endif
                </div>
